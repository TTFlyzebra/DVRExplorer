...
public class DVRActivity extends Activity implements Dvr.DvrTyListener, View.OnClickListener, SocketResult {
    ...
    private FrameLayout bt_rtsp, bt_pho, bt_set,bt_nor,bt_evt;
    private Dvr mDvr;
...
//        progressDialog.setMessage("");
        ...
        //初始化控件
        bt_home = findViewById(R.id.ac_dvr_hs_home);
        bt_rtsp = findViewById(R.id.ac_dvr_hs_rtsp);
        bt_set = findViewById(R.id.ac_dvr_hs_set);
        bt_pho = findViewById(R.id.ac_dvr_hs_pho);
        bt_nor = findViewById(R.id.ac_dvr_hs_nor);
        bt_evt = findViewById(R.id.ac_dvr_hs_evt);
        bt_home.setOnClickListener(this);
        bt_rtsp.setOnClickListener(this);
        bt_pho.setOnClickListener(this);
        bt_set.setOnClickListener(this);
        bt_nor.setOnClickListener(this);
        bt_evt.setOnClickListener(this);

        bt_rtsp.setEnabled(false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ac_dvr_hs_home:
                finish();
                break;
            case R.id.ac_dvr_hs_set:
                if (replaceFragment("SetFragment")) {
                    bt_rtsp.setEnabled(true);
                    bt_pho.setEnabled(true);
                    bt_set.setEnabled(false);
                    bt_nor.setEnabled(true);
                    bt_evt.setEnabled(true);
                }
                break;
            case R.id.ac_dvr_hs_rtsp:
            ...
            case R.id.ac_dvr_hs_pho:
                ...
                break;
            case R.id.ac_dvr_hs_nor:
                if (replaceFragment("FileFragment_NOR1")) {
                    bt_rtsp.setEnabled(true);
                    bt_pho.setEnabled(true);
                    bt_set.setEnabled(true);
                    bt_nor.setEnabled(false);
                    bt_evt.setEnabled(true);
                }
                break;
            case R.id.ac_dvr_hs_evt:
